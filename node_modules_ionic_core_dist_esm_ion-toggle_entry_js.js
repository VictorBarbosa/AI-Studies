...
const Toggle = class {
  constructor(hostRef) {
    ...
    this.disabled = false;
    this.value = 'on';
    this.enableOnOffLabels = _ionic_global_84a10cad_js__WEBPACK_IMPORTED_MODULE_3__.c.get('toggleOnOffLabels');
  ...
  connectedCallback() {
    ...
    return (0,_Users_victorbarbosa_git_AiSamples_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* () {
      _this2.legacyFormController = (0,_form_controller_c60f6bf8_js__WEBPACK_IMPORTED_MODULE_4__.c)(_this2.el);
      /**
  ...
  componentWillLoad() {
    ...
    if (!this.legacyFormController.hasLegacyControl()) {
      this.inheritedAttributes = Object.assign({}, (0,_helpers_c8b0fe32_js__WEBPACK_IMPORTED_MODULE_5__.i)(this.el));
    }
  }
  emitStyle() {
    if (this.legacyFormController.hasLegacyControl()) {
  ...
  renderToggleControl() {
    ...
    }, enableOnOffLabels && mode === 'ios' && [this.renderOnOffSwitchLabels(mode, true), this.renderOnOffSwitchLabels(mode, false)], (0,_index_428032e5_js__WEBPACK_IMPORTED_MODULE_1__.h)("div", {
  ...
  renderToggle() {
    ...
    (0,_helpers_c8b0fe32_js__WEBPACK_IMPORTED_MODULE_5__.d)(true, el, name, checked ? value : '', disabled);
    ...
    }, this.inheritedAttributes)), (0,_index_428032e5_js__WEBPACK_IMPORTED_MODULE_1__.h)("div", {
      class: {
...
Developers can dismiss this warning by removing their usage of the "legacy" property and using the new toggle syntax.`, this.el);
    ...
    }, this.renderToggleControl(), (0,_index_428032e5_js__WEBPACK_IMPORTED_MODULE_1__.h)("label", {
      htmlFor: inputId
