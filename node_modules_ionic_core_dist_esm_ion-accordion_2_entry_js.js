...
const Accordion = class {
  constructor(hostRef) {
    ...
    this.setAria = (expanded = false) => {
       ...
       */
      const root = (0,_helpers_c8b0fe32_js__WEBPACK_IMPORTED_MODULE_4__.g)(ionItem);
    ...
    this.expandAccordion = (initialUpdate = false) => {
      ...
      if (this.shouldAnimate()) {
        (0,_helpers_c8b0fe32_js__WEBPACK_IMPORTED_MODULE_4__.r)(() => {
          ...
          this.currentRaf = (0,_helpers_c8b0fe32_js__WEBPACK_IMPORTED_MODULE_4__.r)( /*#__PURE__*/(0,_Users_victorbarbosa_git_AiSamples_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* () {
            const contentHeight = contentElWrapper.offsetHeight;
            const waitForTransition = (0,_helpers_c8b0fe32_js__WEBPACK_IMPORTED_MODULE_4__.t)(contentEl, 2000);
    ...
    this.shouldAnimate = () => {
      ...
      const animated = _ionic_global_84a10cad_js__WEBPACK_IMPORTED_MODULE_3__.c.get('animated', true);
      if (!animated) {
        return false;
      }
    ...
    this.updateState = /*#__PURE__*/(0,_Users_victorbarbosa_git_AiSamples_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* (initialUpdate = false) {
  ...
  connectedCallback() {
    ...
    if (accordionGroupEl) {
      ...
      (0,_helpers_c8b0fe32_js__WEBPACK_IMPORTED_MODULE_4__.a)(accordionGroupEl, 'ionValueChange', this.updateListener);
    }
  }
  disconnectedCallback() {
    const accordionGroupEl = this.accordionGroupEl;
    if (accordionGroupEl) {
      (0,_helpers_c8b0fe32_js__WEBPACK_IMPORTED_MODULE_4__.b)(accordionGroupEl, 'ionValueChange', this.updateListener);
    }
  }
  componentDidLoad() {
    this.setItemDefaults();
