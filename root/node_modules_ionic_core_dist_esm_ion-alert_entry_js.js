...
/* harmony import */ var _config_80c044f2_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./config-80c044f2.js */ 90059);
/* harmony import */ var _button_active_1ec728c7_js__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./button-active-1ec728c7.js */ 8890);
/* harmony import */ var _overlays_7a231122_js__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./overlays-7a231122.js */ 76999);
...
/* harmony import */ var _framework_delegate_ebba246f_js__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! ./framework-delegate-ebba246f.js */ 77758);
/* harmony import */ var _helpers_c8b0fe32_js__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! ./helpers-c8b0fe32.js */ 63142);
...
/* harmony import */ var _index_e86f0117_js__WEBPACK_IMPORTED_MODULE_14__ = __webpack_require__(/*! ./index-e86f0117.js */ 92894);
...
const iosEnterAnimation = baseEl => {
  const baseAnimation = (0,_animation_80d2c7ea_js__WEBPACK_IMPORTED_MODULE_7__.c)();
  const backdropAnimation = (0,_animation_80d2c7ea_js__WEBPACK_IMPORTED_MODULE_7__.c)();
  const wrapperAnimation = (0,_animation_80d2c7ea_js__WEBPACK_IMPORTED_MODULE_7__.c)();
...
const Alert = class {
  constructor(hostRef) {
    ...
    this.didPresent = (0,_index_428032e5_js__WEBPACK_IMPORTED_MODULE_1__.d)(this, "ionAlertDidPresent", 7);
    this.willPresent = (0,_index_428032e5_js__WEBPACK_IMPORTED_MODULE_1__.d)(this, "ionAlertWillPresent", 7);
    this.willDismiss = (0,_index_428032e5_js__WEBPACK_IMPORTED_MODULE_1__.d)(this, "ionAlertWillDismiss", 7);
    this.didDismiss = (0,_index_428032e5_js__WEBPACK_IMPORTED_MODULE_1__.d)(this, "ionAlertDidDismiss", 7);
    ...
    this.delegateController = (0,_overlays_7a231122_js__WEBPACK_IMPORTED_MODULE_5__.d)(this);
    this.triggerController = (0,_overlays_7a231122_js__WEBPACK_IMPORTED_MODULE_5__.e)();
    this.customHTMLEnabled = _ionic_global_84a10cad_js__WEBPACK_IMPORTED_MODULE_2__.c.get('innerHTMLTemplatesEnabled', _config_80c044f2_js__WEBPACK_IMPORTED_MODULE_3__.E);
    this.processedInputs = [];
    this.processedButtons = [];
    this.presented = false;
    this.onBackdropTap = () => {
      this.dismiss(undefined, _overlays_7a231122_js__WEBPACK_IMPORTED_MODULE_5__.B);
    };
    this.dispatchCancelHandler = ev => {
      const role = ev.detail.role;
      if ((0,_overlays_7a231122_js__WEBPACK_IMPORTED_MODULE_5__.i)(role)) {
  ...
  connectedCallback() {
    (0,_overlays_7a231122_js__WEBPACK_IMPORTED_MODULE_5__.j)(this.el);
    this.triggerChanged();
  }
  componentWillLoad() {
    this.inputsChanged();
  ...
  componentDidLoad() {
     ...
     */
    if (this.gesture || (0,_ionic_global_84a10cad_js__WEBPACK_IMPORTED_MODULE_2__.b)(this) === 'md' || !this.wrapperEl) {
      return;
    }
    this.gesture = (0,_button_active_1ec728c7_js__WEBPACK_IMPORTED_MODULE_4__.c)(this.wrapperEl, refEl => refEl.classList.contains('alert-button'));
  ...
  present() {
    ...
    return (0,_Users_victorbarbosa_git_AiSamples_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* () {
      ...
      _this.currentTransition = (0,_overlays_7a231122_js__WEBPACK_IMPORTED_MODULE_5__.f)(_this, 'alertEnter', iosEnterAnimation, mdEnterAnimation);
      yield _this.currentTransition;
  ...
  dismiss(data, role) {
    var _this2 = this;
    return (0,_Users_victorbarbosa_git_AiSamples_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* () {
      _this2.currentTransition = (0,_overlays_7a231122_js__WEBPACK_IMPORTED_MODULE_5__.g)(_this2, data, role, 'alertLeave', iosLeaveAnimation, mdLeaveAnimation);
   ...
   */
  onDidDismiss() {
    return (0,_overlays_7a231122_js__WEBPACK_IMPORTED_MODULE_5__.h)(this.el, 'ionAlertDidDismiss');
  }
  /**
   * Returns a promise that resolves when the alert will dismiss.
   */
  onWillDismiss() {
    return (0,_overlays_7a231122_js__WEBPACK_IMPORTED_MODULE_5__.h)(this.el, 'ionAlertWillDismiss');
  }
  rbClick(selectedInput) {
    ...
    (0,_overlays_7a231122_js__WEBPACK_IMPORTED_MODULE_5__.s)(selectedInput.handler, selectedInput);
  ...
  callButtonHandler(button, data) {
    return (0,_Users_victorbarbosa_git_AiSamples_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* () {
      if (button === null || button === void 0 ? void 0 : button.handler) {
        ...
        const returnData = yield (0,_overlays_7a231122_js__WEBPACK_IMPORTED_MODULE_5__.s)(button.handler, data);
        if (returnData === false) {
  ...
  renderCheckbox() {
    ...
    }, inputs.map(i => (0,_index_428032e5_js__WEBPACK_IMPORTED_MODULE_1__.h)("button", {
      type: "button",
    ...
    }, i.label)), mode === 'md' && (0,_index_428032e5_js__WEBPACK_IMPORTED_MODULE_1__.h)("ion-ripple-effect", null))));
  }
  renderRadio() {
    const inputs = this.processedInputs;
    if (inputs.length === 0) {
  ...
  renderInput() {
    ...
    return (0,_index_428032e5_js__WEBPACK_IMPORTED_MODULE_1__.h)("div", {
      ...
      if (i.type === 'textarea') {
        ...
        }, (0,_index_428032e5_js__WEBPACK_IMPORTED_MODULE_1__.h)("textarea", Object.assign({
          placeholder: i.placeholder,
          value: i.value,
          id: i.id,
          tabIndex: i.tabindex
  ...
  renderAlertButtons() {
    ...
    }, buttons.map(button => (0,_index_428032e5_js__WEBPACK_IMPORTED_MODULE_1__.h)("button", {
      type: "button",
      id: button.id,
      class: buttonClass(button),
      tabIndex: 0,
      onClick: () => this.buttonClick(button)
    }, (0,_index_428032e5_js__WEBPACK_IMPORTED_MODULE_1__.h)("span", {
      class: "alert-button-inner"
    }, button.text), mode === 'md' && (0,_index_428032e5_js__WEBPACK_IMPORTED_MODULE_1__.h)("ion-ripple-effect", null))));
  }
  ...
  render() {
    ...
    return (0,_index_428032e5_js__WEBPACK_IMPORTED_MODULE_1__.h)(_index_428032e5_js__WEBPACK_IMPORTED_MODULE_1__.H, Object.assign({
      ...
      class: "alert-head"
    }, header && (0,_index_428032e5_js__WEBPACK_IMPORTED_MODULE_1__.h)("h2", {
      id: hdrId,
      class: "alert-title"
    }, header), subHeader && (0,_index_428032e5_js__WEBPACK_IMPORTED_MODULE_1__.h)("h2", {
      id: subHdrId,
      class: "alert-sub-title"
    }, subHeader)), this.renderAlertMessage(msgId), this.renderAlertInputs(), this.renderAlertButtons()), (0,_index_428032e5_js__WEBPACK_IMPORTED_MODULE_1__.h)("div", {
      tabindex: "0"
    }));
  }
  get el() {
