...
/* harmony import */ var _data_b8307d99_js__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./data-b8307d99.js */ 8143);
...
const DatetimeButton = class {
  constructor(hostRef) {
    ...
    this.setDateTimeText = () => {
       ...
       */
      const parsedDatetimes = (0,_data_b8307d99_js__WEBPACK_IMPORTED_MODULE_6__.q)(parsedValues.length > 0 ? parsedValues : [(0,_data_b8307d99_js__WEBPACK_IMPORTED_MODULE_6__.t)()]);
      /**
      ...
      const use24Hour = (0,_data_b8307d99_js__WEBPACK_IMPORTED_MODULE_6__.J)(locale, hourCycle);
      this.dateText = this.timeText = undefined;
      switch (datetimePresentation) {
        case 'date-time':
        case 'time-date':
          const dateText = (0,_data_b8307d99_js__WEBPACK_IMPORTED_MODULE_6__.T)(locale, firstParsedDatetime);
          const timeText = (0,_data_b8307d99_js__WEBPACK_IMPORTED_MODULE_6__.K)(locale, firstParsedDatetime, use24Hour);
          if (preferWheel) {
        ...
        case 'date':
          if (multiple && parsedValues.length !== 1) {
            ...
            this.dateText = (0,_data_b8307d99_js__WEBPACK_IMPORTED_MODULE_6__.T)(locale, firstParsedDatetime);
          }
          break;
        case 'time':
          this.timeText = (0,_data_b8307d99_js__WEBPACK_IMPORTED_MODULE_6__.K)(locale, firstParsedDatetime, use24Hour);
          break;
        case 'month-year':
          this.dateText = (0,_data_b8307d99_js__WEBPACK_IMPORTED_MODULE_6__.G)(locale, firstParsedDatetime);
          break;
        case 'month':
          this.dateText = (0,_data_b8307d99_js__WEBPACK_IMPORTED_MODULE_6__.S)(locale, firstParsedDatetime, {
            month: 'long'
          });
          break;
        case 'year':
     ...
     */
    this.waitForDatetimeChanges = /*#__PURE__*/(0,_Users_victorbarbosa_git_AiSamples_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* () {
      const {
        datetimeEl
      } = _this;
      if (!datetimeEl) {
      ...
      return new Promise(resolve => {
        (0,_helpers_c8b0fe32_js__WEBPACK_IMPORTED_MODULE_3__.a)(datetimeEl, 'ionRender', resolve, {
          once: true
        });
      });
    });
    ...
    this.presentOverlay = /*#__PURE__*/function () {
      var _ref3 = (0,_Users_victorbarbosa_git_AiSamples_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* (ev, needsPresentationChange, triggerEl) {
        const {
          overlayEl
        } = _this;
        if (!overlayEl) {
  ...
  componentWillLoad() {
    ...
    return (0,_Users_victorbarbosa_git_AiSamples_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* () {
      ...
      (0,_helpers_c8b0fe32_js__WEBPACK_IMPORTED_MODULE_3__.c)(datetimeEl, () => {
        ...
        (0,_helpers_c8b0fe32_js__WEBPACK_IMPORTED_MODULE_3__.a)(datetimeEl, 'ionValueChange', _this2.setDateTimeText);
        /**
  ...
  render() {
    ...
    return (0,_index_428032e5_js__WEBPACK_IMPORTED_MODULE_1__.h)(_index_428032e5_js__WEBPACK_IMPORTED_MODULE_1__.H, {
    ...
    }, dateText && (0,_index_428032e5_js__WEBPACK_IMPORTED_MODULE_1__.h)("button", {
      ...
      name: "date-target"
    }, dateText), mode === 'md' && (0,_index_428032e5_js__WEBPACK_IMPORTED_MODULE_1__.h)("ion-ripple-effect", null)), timeText && (0,_index_428032e5_js__WEBPACK_IMPORTED_MODULE_1__.h)("button", {
      class: "ion-activatable",
      id: "time-button",
      "aria-expanded": datetimeActive ? 'true' : 'false',
      ...
      name: "time-target"
    }, timeText), mode === 'md' && (0,_index_428032e5_js__WEBPACK_IMPORTED_MODULE_1__.h)("ion-ripple-effect", null)));
  }
  get el() {
