...
const ProgressBar = class {
  ...
  render() {
    ...
    const paused = _ionic_global_84a10cad_js__WEBPACK_IMPORTED_MODULE_1__.c.getBoolean('_testing');
...
const renderIndeterminate = () => {
  return (0,_index_428032e5_js__WEBPACK_IMPORTED_MODULE_0__.h)("div", {
    part: "track",
...
const renderProgress = (value, buffer) => {
  const finalValue = (0,_helpers_c8b0fe32_js__WEBPACK_IMPORTED_MODULE_2__.l)(0, value, 1);
  const finalBuffer = (0,_helpers_c8b0fe32_js__WEBPACK_IMPORTED_MODULE_2__.l)(0, buffer, 1);
  return [(0,_index_428032e5_js__WEBPACK_IMPORTED_MODULE_0__.h)("div", {
    part: "progress",
    class: "progress",
    style: {
