...
const Range = class {
  constructor(hostRef) {
    ...
    this.ionInput = (0,_index_428032e5_js__WEBPACK_IMPORTED_MODULE_1__.d)(this, "ionInput", 7);
    ...
    this.ionKnobMoveStart = (0,_index_428032e5_js__WEBPACK_IMPORTED_MODULE_1__.d)(this, "ionKnobMoveStart", 7);
    this.ionKnobMoveEnd = (0,_index_428032e5_js__WEBPACK_IMPORTED_MODULE_1__.d)(this, "ionKnobMoveEnd", 7);
    ...
    this.clampBounds = value => {
      return (0,_helpers_c8b0fe32_js__WEBPACK_IMPORTED_MODULE_5__.l)(this.min, value, this.max);
    };
    ...
    this.setupGesture = /*#__PURE__*/(0,_Users_victorbarbosa_git_AiSamples_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* () {
    ...
    this.handleKeyboard = (knob, isIncrease) => {
      ...
      if (knob === 'A') {
        this.ratioA = (0,_helpers_c8b0fe32_js__WEBPACK_IMPORTED_MODULE_5__.l)(0, this.ratioA + step, 1);
      } else {
        this.ratioB = (0,_helpers_c8b0fe32_js__WEBPACK_IMPORTED_MODULE_5__.l)(0, this.ratioB + step, 1);
      }
  ...
  debounceChanged() {
     ...
     */
    this.ionInput = debounce === undefined ? originalIonInput !== null && originalIonInput !== void 0 ? originalIonInput : ionInput : (0,_helpers_c8b0fe32_js__WEBPACK_IMPORTED_MODULE_5__.j)(ionInput, debounce);
  }
  minChanged() {
    if (!this.noUpdate) {
      this.updateRatio();
  ...
  connectedCallback() {
    ...
    this.legacyFormController = (0,_form_controller_c60f6bf8_js__WEBPACK_IMPORTED_MODULE_4__.c)(el);
    this.updateRatio();
    ...
    this.contentEl = (0,_index_7029cddd_js__WEBPACK_IMPORTED_MODULE_3__.f)(this.el);
  }
  ...
  onStart(detail) {
    ...
    if (contentEl) {
      this.initialContentScrollY = (0,_index_7029cddd_js__WEBPACK_IMPORTED_MODULE_3__.d)(contentEl);
    }
    const rect = this.rect = this.rangeSlider.getBoundingClientRect();
    const currentX = detail.currentX;
    // figure out which knob they started closer to
    let ratio = (0,_helpers_c8b0fe32_js__WEBPACK_IMPORTED_MODULE_5__.l)(0, (currentX - rect.left) / rect.width, 1);
  ...
  onEnd(detail) {
    ...
    if (contentEl) {
      (0,_index_7029cddd_js__WEBPACK_IMPORTED_MODULE_3__.r)(contentEl, initialContentScrollY);
    }
    this.update(detail.currentX);
    this.pressedKnob = undefined;
    this.emitValueChange();
...
Developers can dismiss this warning by removing their usage of the "legacy" property and using the new range syntax.`, this.el);
    ...
    (0,_helpers_c8b0fe32_js__WEBPACK_IMPORTED_MODULE_5__.d)(true, el, this.name, JSON.stringify(this.getValue()), disabled);
    return (0,_index_428032e5_js__WEBPACK_IMPORTED_MODULE_1__.h)(_index_428032e5_js__WEBPACK_IMPORTED_MODULE_1__.H, {
      ...
      name: "start"
    }), this.renderRangeSlider(), (0,_index_428032e5_js__WEBPACK_IMPORTED_MODULE_1__.h)("slot", {
      name: "end"
    }));
  }
  renderRange() {
  ...
  renderRangeSlider() {
    ...
    let {
      labelText
    } = (0,_helpers_c8b0fe32_js__WEBPACK_IMPORTED_MODULE_5__.e)(el, rangeId);
    ...
    }, ticks.map(tick => (0,_index_428032e5_js__WEBPACK_IMPORTED_MODULE_1__.h)("div", {
...
const renderKnob = (rtl, {
  ...
  return (0,_index_428032e5_js__WEBPACK_IMPORTED_MODULE_1__.h)("div", {
    ...
    "aria-valuenow": value
  }, pin && (0,_index_428032e5_js__WEBPACK_IMPORTED_MODULE_1__.h)("div", {
    class: "range-pin",
    role: "presentation",
    part: "pin"
  }, pinFormatter(value)), (0,_index_428032e5_js__WEBPACK_IMPORTED_MODULE_1__.h)("div", {
    class: "range-knob",
    role: "presentation",
    part: "knob"
  }));
...
const ratioToValue = (ratio, min, max, step) => {
  ...
  return (0,_helpers_c8b0fe32_js__WEBPACK_IMPORTED_MODULE_5__.l)(min, value, max);
};
const valueToRatio = (value, min, max) => {
  return (0,_helpers_c8b0fe32_js__WEBPACK_IMPORTED_MODULE_5__.l)(0, (value - min) / (max - min), 1);
};
let rangeIds = 0;
Range.style = {
  ios: rangeIosCss,
